...
train_set = SegmentedSAEFolder(args.d, max_pad=3, valid_objects=valid_objects, normalize=True, old=False,
                               partitions=list(range(10)), with_post=True)
val_set = SegmentedSAEFolder(args.d, max_pad=3, valid_objects=valid_objects, normalize=True, eff_mu=train_set.eff_mu,
                             eff_std=train_set.eff_std, old=False, partitions=[10], with_post=True)
test_set = SegmentedSAEFolder(args.d, max_pad=3, valid_objects=valid_objects, normalize=True, eff_mu=train_set.eff_mu,
                              eff_std=train_set.eff_std, old=False, partitions=[11], with_post=True)
