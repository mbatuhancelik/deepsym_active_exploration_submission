...
for e in range(EPOCH):
    ...
    torchvision.utils.save_image(x_all, f"save/npuzzle_ae_head/epoch{e+1}.png", nrow=10, normalize=True, pad_value=1.0)
    torch.save(encoder, "save/npuzzle_ae_head/encoder_last.bin")
    torch.save(decoder, "save/npuzzle_ae_head/decoder_last.bin")
